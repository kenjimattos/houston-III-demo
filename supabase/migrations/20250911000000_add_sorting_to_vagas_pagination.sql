-- Adiciona funcionalidade de ordenação à função get_vagas_paginated
-- Permite ordenar por: data de criação, nome do hospital, setor, especialidade, período, status e número de candidaturas
-- Remove a função existente para evitar conflito de assinatura
DROP FUNCTION IF EXISTS get_vagas_paginated(
  integer,
  integer,
  uuid [],
  uuid [],
