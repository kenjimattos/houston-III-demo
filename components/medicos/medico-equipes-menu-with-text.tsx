...
interface MedicoEquipesMenuWithTextProps {
  medicoId: string
  medicoNome: string
  equipes: Equipe[]
...
export function MedicoEquipesMenuWithText({
  medicoId,
  medicoNome,
  equipes,
  equipesDoMedico,
  onAddToEquipe,
  onRemoveFromEquipe
}: MedicoEquipesMenuWithTextProps) {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="sm" className="gap-2" title="Gerenciar equipes do médico">
